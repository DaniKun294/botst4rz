...
//
const BotName = 'RUBYCLOWN BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/dan_zx666'; // Nama Instagramlu cok
const whatsapplu = '0823-2242-7684'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'COMMINGSOON'; // OFFICIAL GRUP LU 1
const grupch2 = 'COMMINGSOON'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
